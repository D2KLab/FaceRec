...
def main():
    ...
    align_command = 'python3 FaceDetector.py ' + args.input_dir + ' ' + args.align_dir + ' --image_size 182' + ' --margin 44'
    ...
    with tf.Graph().as_default():
        ...
        with tf.compat.v1.Session() as sess:
            ...
            if not os.path.exists(os.path.dirname(classifier_filename_exp)):
                os.makedirs(os.path.dirname(classifier_filename_exp))
