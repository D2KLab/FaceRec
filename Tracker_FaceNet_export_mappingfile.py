...
def main():
    ...
    with tf.compat.v1.Graph().as_default():
        with tf.compat.v1.Session(
            ...
            show_rate = 0.8  # if set it smaller will display smaller frames
                        ...
                        if face_sums > 0:
                            ...
                            for i, item in enumerate(faces):
                                ...
                                if f > 0.99:
                                    ...
                                    # face additional attribute(index 0:face score; index 1:0 represents front face and 1 for side face )
